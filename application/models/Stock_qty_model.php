...
class Stock_qty_model extends Custom_Model {
        ...
        public function get_last_qty($filter=0,$limit=50, $offset=0, $count=0)
        { 
...
//           $this->cek_count($count,$limit,$offset);
        ...
        { 
           $this->db->select('stock_location.id, stock_location.name as stock_location_name, stock_location.complete_name, stock_location.comment,'
                   . '        stock_location.usage, stock_location.active'
                );
